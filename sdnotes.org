...
Simulation from 6/11/23: more activity in layer 4, CSD looks better and matches NHP data better; still no clear entrainment; TC and HTC cells do not follow the 40Hz rhythm as closely as they did before, there seems to be a slow rhythm involved;

-> Simulations for 7/11/23:
	- 1) Label 'ASSR_7_11_23_1': increase IC-> Thal input (cfg.ICThalweightECore = 1.5 # 1.0 and cfg.ICThalweightICore = 1.0 # 0.25)
	-> TC entrainment better; little activity in L4 and no in L2/3
	
	- 2) Label 'ASSR_7_11_23_2': same as 1) but also increased Thal->L4E (cfg.thalL4E = 1.5 #1.0)
	-> TC entrainment better; little activity in L4 and no in L2/3; PV4 activity still very high

	- 3) Label 'ASSR_7_11_23_3': cfg.ICThalweightICore = 0.5 # 0.25
	
	
	
	- 4) Label 'ASSR_7_11_23_3': cfg.ICThalweightICore = 0.5 # 0.25 and cfg.thalL4PV = 0.25 # 0.5
	
	
	- 5) Label 'ASSR_7_11_23_3': cfg.ICThalweightICore = 0.5 # 0.25 and cfg.thalL4PV = 0.25 # 0.5 and cfg.thalL4SOM = 0.25 # 0.5
	

Simulations for 17/11/23: 17_11_23_1
...
Better L4 entrainment! Better CSD! No activity in L2/3

Simulations for 20/11/23:
	
 -1) 20_11_23_1: test Sam's params
...
=> Worse than 17_11_23_1; L4 40Hz entrainment weaker
...
=> Slightly better than 17_11_23_1; Slightly stronger 40Hz entrainment; still no L2/3 activity
...
=> Worse than 20_11_23_2; Weaker 40Hz entrainment; still no L2/3 activity

Simulations for 4/12/23:
...
=> good L4 entrainment; still no L2/3 activity
...
=> better L4 entrainment than 4_12_23_1 (especially early [1750-2000ms]); still no L2/3 activity
...
=> stronger L4 entrainment; activity in L3 (weakly modulated by the 40Hz) but still no L2 activity; however, the CSD look very off

Simulations for 5/12/23:
...
=> weaker entrainment in L4 early; long latency for activity in L4; strong entrainment late (>2200ms)
...
=> CSD ok; quite strong L4 entrainment early; slightly weaker entrainment late; no L2/3 activity
...
=> much weaker entrainment than 5_12_23_2; entrainment starts late (>2200ms)
...
=> weak and late entrainment

Simulations for 6/12/23:
...
=> no IT3 firing, very high PV3 and VIP3 firing
...
=> good IT3 firing, even a little IT2 firing; PV4 and NGF4 firing very high; VIP3 and NGF3 firing very high; good early and late entrainment in L4, L3 and even L2;
...
=> good/high IT3 firing; PV4 and NGF4 firing very high; VIP3 and NGF3 firing very high; L4 and L2 entrainment weaker but L3 entrainment a little stronger than 6_12_23_2

Simulations for 8/12/23:
...
=> good/high IT3 firing; PV4 and NGF4 firing very high; VIP3 and NGF3 firing very high; L4 and L2 entrainment weaker but L3 entrainment a little stronger than 6_12_23_2; late entrainment very strong 
...
=> good L4 but weaker L3 and L2 activity; weaker L4 and not L3 and L2 entrainment
...
=> similar to 8_12_23_2

Simulations for 11/12/23:

 -1) 11_12_23_1: Sam N's new params
...
=> weak entrainment; no L3 and L2 activity; CSD looks better though
...
=> weak entrainment; no L3 and L2 activity;
...
=> weak entrainment; no L3 and L2 activity; although better than other 12_12_23_*
...
=> weak/moderate entrainment; no L3 and L2 activity; although better than other 12_12_23_4

Simulations for 14/12/23:
...
=> better L3 and L2 (although still weak for L2) activity; good L4 and weak L3+L2 entrainment (late entrainment even stronger); Very high firing of PV4+NGF4, VIP3+NGF3 and NGF2  
...
=> very similar to 14_12_23_1; reducing matrixcorefactor doesn't have a big effect

Simulations for 15/12/23:
...
=> also very similar to 14_12_23_1; reducing matrixcorefactor doesn't have a big effect
...
=> also very similar to the above sims
...
cfg.L4L3SOM  = 1.0 
 ...
 => similar to above; better L3 entrainment but weaker L2 entrainment


Simulations for 20/12/23:
...
=> again higher L3 entrainment but weaker L2 (as in 15_12_23_4); but no real effect on high interneuron rates
...
Simulations for Grid_04_01_24:

Something wrong with part1 (therefore only L4L3NGF=0.5)!
...
thalL4VIP=[0.25,0.5],thalL4NGF=[0.25,0.5],L4L3VIP=[0.25,0.5],L4L3NGF=[0.5]

 -1) 0_0_0_0: thalL4VIP=0.25,thalL4NGF=0.25,L4L3VIP=0.25:
 => CSD better; good L4 activity, no L3+L2 activity; good L4, no L2+L3 entrainment; high VIP4+NGF4 activity, very high PV3+VIP3 activity, high NGF2 activity (but no L2 activity very likely caused by no L3 activity)
 -2) 0_0_1_0: thalL4VIP=0.25,thalL4NGF=0.25,L4L3VIP=0.5:
 => same as 0_0_0_0
 -3) 0_1_0_0: thalL4VIP=0.25,thalL4NGF=0.5,L4L3VIP=0.25:
 => similar to the above
 -4) 0_1_1_0: thalL4VIP=0.25,thalL4NGF=0.5,L4L3VIP=0.5:
 => similar to the above
 -5) 1_0_0_0: thalL4VIP=0.5,thalL4NGF=0.25,L4L3VIP=0.25:
 => similar to the above
 -6) 1_0_1_0: thalL4VIP=0.5,thalL4NGF=0.25,L4L3VIP=0.5:
 => similar to the above
 -7) 1_1_0_0: thalL4VIP=0.5,thalL4NGF=0.5,L4L3VIP=0.25:
 => similar to the above
 -8) 1_1_1_0: thalL4VIP=0.5,thalL4NGF=0.5,L4L3VIP=0.5:
 => similar to the above


Simulations for Grid_07_01_24:
...
cfg.EICellTypeGain= {'PV': 1.0, 'SOM': 1.0, 'VIP': 1.0, 'NGF': 0.5} # scales down NGF activity!?!

=> scaling down NGF activity works. Scaling from factor 1.0 -> 0.5 brings down (compared to 20_12_23_2) NGF4: 384 -> 75.6 (early)/  368 -> 92.7 (late), NGF3:  296 -> 23.3 (early)/ 247 -> 18.9 (late) , NGF2:  460 -> 78.7 (early)/ 517 -> 73.6 (late)
=> however, this has little effect on L3 and L2 activity and entrainment


 -2) 08_01_24_2: SamNs PopGain params
...
=> 
 ...
 -4) ASSR_grid_08_01_24_lesath
 
thalL4VIP =[0.25, 0.5], thalL4NGF =[0.25, 0.5], L4L3VIP =[0.25, 0.5], L4L3NGF =[0.25, 0.5]
...
0_0_0_0: good L4 activity and entrainment, no L3+L2; high PV3 and VIP3 activity
0_0_0_1: similar
all others probably all similar; skip analysis

Simulations for 09_01_24:

 -1) ASSR_grid_09_01_24_lesath (8 sims)
...
cfg.EICellTypeGain= {'PV': 1.0, 'SOM': 1.0, 'VIP': 1.0, 'NGF': 0.5} 

=> CSD looks better; Good L4 activity, no L3+L2 activity; very high PV3 nd VIP3 activity, high NGF2 activity; entrainment: L4 good, L3+L2 none

-3) 09_01_24_2: SamNs PopGain params! Rerun this because of bugs in the spike output!! 
...
=> good L4 activity, almost no L3+L2 activity; NGF4 activity high, PV3+VIP3 activity high, NGF2 high; entrainment in L4 good
...
=> no L3+L2 activity, weak L4 activity; very high PV4 activity, PV3 very high, VIP3 high, NGF overall lower but still wuite high; very weak L4 entrainment, none in L3+L2
...
cfg.EICellTypeGain= {'PV': 1.0, 'SOM': 1.0, 'VIP': 1.0, 'NGF': 0.1} 

=> same as 10_01_24_1, lowering NGF celltype gain hardly had any effect
...
Sims for 12_01_24:
 ...
 -1) 12_01_24_1 (based on 14_12_23_1: better L3 and L2 (although still weak for L2) activity; good L4 and weak L3+L2 entrainment (late entrainment even stronger); Very high firing of PV4+NGF4, VIP3+NGF3 and NGF2  )

cfg.EIPopGain = {'NGF1': 1.0, 'SOM2': 1.0, 'PV2': 1.0, 'VIP2': 1.0, 'NGF2': 1.0, 'SOM3': 1.0, 'PV3': 1.0, 'VIP3': 1.0, 'NGF3': 1.0, 'SOM4': 1.0, 'PV4': 0.5, 'VIP4': 1.0, 'NGF4': 1.0, 'SOM5A': 1.0, 'PV5A': 1.0, 'VIP5A': 1.0, 'NGF5A': 1.0, 'SOM5B': 1.0, 'PV5B': 1.0, 'VIP5B': 1.0, 'NGF5B': 1.0, 'SOM6': 1.0, 'PV6': 1.0, 'VIP6': 1.0, 'NGF6': 1.0} 
...
=> L4 activity strong, L3 also strong, no L2; NGF4 exteremely high (>400) and PV4 very high (128Hz); PV3 good, NGF3 (>400Hz); nothing in L2; entrainment good in L4, very strong in L3


 -2) 12_01_24_2 (based on SamN's params) 
...
=> CSD better (too strong input to L1); L4 activity, very little L3 and no L2; PV3(125Hz)+VIP3(76Hz) very high; NGF2(75Hz) still quite high; entrainment in L4 good (substantially weaker than 12_01_24_1 though; power ~5-6 vs ~12-14)

 -3) 12_01_24_3 (based on 14_12_23_1: better L3 and L2 (although still weak for L2) activity; good L4 and weak L3+L2 entrainment (late entrainment even stronger); Very high firing of PV4+NGF4, VIP3+NGF3 and NGF2  )
...
cfg.EIPopGain = {'NGF1': 1.0, 'SOM2': 1.0, 'PV2': 1.0, 'VIP2': 1.0, 'NGF2': 1.0, 'SOM3': 1.0, 'PV3': 0.5, 'VIP3': 1.0, 'NGF3': 1.0, 'SOM4': 1.0, 'PV4': 0.5, 'VIP4': 1.0, 'NGF4': 1.0, 'SOM5A': 1.0, 'PV5A': 1.0, 'VIP5A': 1.0, 'NGF5A': 1.0, 'SOM5B': 1.0, 'PV5B': 1.0, 'VIP5B': 1.0, 'NGF5B': 1.0, 'SOM6': 1.0, 'PV6': 1.0, 'VIP6': 1.0, 'NGF6': 1.0} 
...
=> L4 activity good, no L3 activity, but good L2 activity; PV4 good (~7Hz), VIP4(115Hz)+NGF4(135Hz) very high; PV3(135Hz)+VIP3(96Hz)+NGF3(70Hz) very high; NGF2(234Hz) very high; entrainment in L4 very high (power ~40), in L2 very good (~12), none in L3

 -4) 12_01_24_4 (based on SamN's params) 
...
=> L4 activity good, L2 activity good, L3 activity very weak; PV4 good (~6Hz), VIP4(67Hz)+NGF4(124Hz) quite high; PV3(119Hz)+VIP3(107Hz)+NGF3(39Hz) very high; NGF2(135Hz) very high; entrainment weaker than 12_01_24_3 L4 (~8), L2(~0.5), L3 none
...
cfg.EIPopGain = {'NGF1': 1.0, 'SOM2': 1.0, 'PV2': 1.0, 'VIP2': 1.0, 'NGF2': 1.0, 'SOM3': 1.0, 'PV3': 0.25, 'VIP3': 0.5, 'NGF3': 1.0, 'SOM4': 1.0, 'PV4': 0.5, 'VIP4': 1.0, 'NGF4': 1.0, 'SOM5A': 1.0, 'PV5A': 1.0, 'VIP5A': 1.0, 'NGF5A': 1.0, 'SOM5B': 1.0, 'PV5B': 1.0, 'VIP5B': 1.0, 'NGF5B': 1.0, 'SOM6': 1.0, 'PV6': 1.0, 'VIP6': 1.0, 'NGF6': 1.0} 
...
=> L4 activity good, L3 better but still weak, L2 activity good; PV4(14Hz) good, VIP4(122Hz)+NGF4(154Hz) activity very high; PV3(114Hz)+NGF3(74Hz) still very high; NGF2(264Hz) very high; entrainment L4 strong (~30), L3 very weak (~0.02), L2 very strong (~50); MUA loos much better!
...
=> very high activity in L4+L3, none in L2; interneuron activity in L4 resonable, SOM4(205Hz) very high; PV3(184Hz)+SOM3(137Hz) very high; none in L2; entrainment really high L4(~130) and L3(~30), none in L2
...
=> L4 activity (but getting weaker with ongoing input), high L3 activity, no L2; no entrainment
...
=> strong L4 activity, very strong L3 activity, no L2 activity; PV4(8Hz) good, SOM4(198Hz) very high; SOM3(125Hz)+PV3(136Hz) very high; nothing in L2; entrainment L4(~110)+L3(~10); MUA okish
...
=> strong L4 activity, very strong L3 activity, no L2 activity; PV4(18Hz) good, SOM4(216Hz) very high; SOM3(197Hz)+PV3(137Hz) very high; nothing in L2; entrainment L4(~120)+L3(~20); MUA okish, a little better than 17_01_24_1
...
=> strong L4 activity, very high L3 activity, no L2 activity; PV4(12Hz) good, SOM4(199Hz) very high; SOM3(191Hz)+PV3(133Hz) very high; nothing in L2; entrainment L4(~120)+L3(~20); MUA okish, a little better than 17_01_24_1
...
=> strong L4 activity, good L3 activity, no L2 activity; PV4(6Hz) good, SOM4(178Hz) very high; SOM3(32Hz)+PV3(145Hz)+VIP3(60Hz) (very) high; nothing in L2; entrainment L4(~90)+L3(~5-10); MUA good initial 200ms, not stable
...
=> CSD looks better, although still a lot of activity in L1; L4 activity good, L3 weaker but good, no L2; SOM4(57Hz) still a bit high; PV3(121Hz)+VIP3(99Hz) still very high; PV2(40Hz) quite high for no pyr activity; entrainment L4(~90-95)+L3(~0.35); MUA goodish 
...
Sims for 29_01_24:
 -1) 29_01_24_artFB_test_1 (redo sims from 24th and 26th but switch on artFB variable!!)
...
=> all three artFB sims did not have a big effect. Increase number of cells in in stimulus generation

 -4) 29_01_24_alterSyn_test_1 
...
cfg.artFB = 0 # this switches the feedback off regardless of the weight and prob below
cfg.artFBweight = 2.5
cfg.artFBprob = 0.5

# place TCM->3 connections on the apical trunk (avoiding the tuft in L1/L2)

=> hardly any effect

 -5) 29_01_24_alterSyn_test_2 
...
# place TCM->5B connections on the apical trunk (avoiding the tuft in L1/L2)

=> also hardly any effect (check implementation for bugs!)



Sims for 30_01_24:
 -1) 30_01_24_artFB_test_1 
...
# input file: FBinput_test_numCell200.pkl

=> no visible effect in the CSD

 -2) 30_01_24_artFB_test_2 
...
=> small changes in CSD and MUA

 -3) 30_01_24_artFB_test_3 
...
# place TCM->5 connections (i.e. IT5A, IT5B, PT5B) on the apical trunk (avoiding the tuft in L1/L2)

 -5) 30_01_24_artFB_test_4 
...
Sims for 31_01_24:
 -1) 31_01_24_artFB_alterSyn_test_1 
...
# input file: FBinput_test_numCell200.pkl
# place TCM->2,3,4,5,6 connections on the apical trunk (avoiding the tufts)

cfg.seeds = {'conn': 12345, 'stim': 1, 'loc': 1}

 -2) 02_02_24_alterSyn_test_2
...
Sims for 06_02_24:
 -1) 06_02_24_artFB_test_1

# reduce NGF1 gain (might decrease strong sink in L1) [wrt 02_02_24_artFB_test_1]
...
cfg.artFBprob = 0.5
 ...
 -2) 06_02_24_artFB_test_2

# increase artFBweight to increase L2/3 delayed sinks [wrt 06_02_24_artFB_test_1]
...
Sims for 08_02_24:
 -1) 08_02_24_L2L3_test_1

# reduce input to NGF1
...
cfg.alterSyn = 0
cfg.alterSyn2 = 0
# altered synaptic input to E->NGF1

=> accidentally with FB!
=> No effect on CSD L1 sink but seems to slightly reduce MUA in L1!

 -2) 08_02_24_L2L3_test_2
...
cfg.alterSyn = 0
cfg.alterSyn2 = 0
# altered synaptic input  TC/TCM->NGF1

=> similar to 08_02_24_L2L3_test_1

 -3) 08_02_24_L2L3_test_3
...
# altered synaptic input NGF1->E (trunk instead of tuft)
 => also similar to 08_02_24_1


Sims for 12_02_24:
 -1) 12_02_24_L2L3_test_1
...
# Rerun of 08_02_24_L2L3_test_1 but without the feedback now!

 -2) 12_02_24_L2L3_test_2
...
# all alterations together 

 -3) 12_02_24_L2L3_test_3
