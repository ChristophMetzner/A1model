...
# place TCM->5B connections on the apical trunk (avoiding the tuft in L1/L2)
 ...
 -7) 29_01_24_artFB_alterSyn_test_1 (tests both together) 
...
cfg.artFB = 1 # this switches the feedback off regardless of the weight and prob below
cfg.artFBweight = 1.0
cfg.artFBprob = 0.1
